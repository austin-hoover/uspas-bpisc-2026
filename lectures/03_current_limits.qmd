...
Define new variable $R$:

\begin{align}
\tilde{r} = \left( \frac{\beta_0}{\beta}\right)^{1/2} R ,
\end{align}

where $\beta_0$ is the velocity at $s = 0$.
...
Approximate potential as $\phi(r, z) = \phi_0 \cos(\pi z / L)$.d

Conservation of energy:

\begin{align}
\frac{1}{2} m v^2 + 2 q \phi &= \text{constant} \\
\Delta \left( v^2 \right) &= -\Delta \left( \frac{2 q \phi}{m} \right) \\
