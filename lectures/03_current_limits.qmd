...
## Derivation from force balance in non-relativistic beams
...
Approximate potential as $\phi(r, z) = \phi_0 \cos(\pi z / L)$.
...
v' &\approx \frac{q \phi_0}{m v_0} \left( \frac{\pi}{L} \right) \sin \left( \frac{\pi z}{L} \right)
\end{aligned}
\end{equation}
...
\begin{aligned}
R'' 
&= \frac{1}{2} \frac{\beta}{\beta_0} \frac{Q}{R} - \frac{3}{4} \left(\frac{\beta'}{\beta}\right)^2 R
&\approx \frac{1}{2} \frac{Q}{R} - \frac{3}{4} \left(\frac{\beta'}{\beta}\right)^2 R \\\
\end{aligned}
\end{equation}
