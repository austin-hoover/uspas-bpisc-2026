...
\begin{aligned}
    \frac{1}{r} \frac{\partial}{\partial r} \left( r \frac{\partial V^{(self)}}{\partial r} \right) 
    + \frac{\partial^2 V^{(self)}}{\partial s^2} 
    = -\frac{\rho(r, z)}{\epsilon_0}.
\end{aligned}
\end{equation}

Solving for $\partial V^{(self)} / \partial r$ relates the radial electric field to $z$-derivative of the potential:

\begin{equation}
\begin{aligned}
    E_r^{(self)} 
    = -\frac{\partial V^{(self)}}{\partial r} 
    = \frac{\lambda(r)}{2 \pi \epsilon_0 r} + \frac{1}{2} \frac{\partial^2 V^{(self)}}{\partial s^2} r,
\end{aligned}
\end{equation}
...
Including the linear self fields adds a driving term to the right hand side:
