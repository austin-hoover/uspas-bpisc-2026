...
Define rigidity $[B\rho] = p/q = \gamma\beta m c / q$ and linear focusing strengths $\kappa_{x, y} = \pm q G / [B\rho]$.
...
\tilde{x}'' 
&= \frac{\langle{xx''}\rangle}{\tilde{x}} + \frac{\langle{xx}\rangle\langle{x'x'}\rangle - \langle{xx'}\rangle\langle{xx'}\rangle}{\tilde{x}^3} \\
&= \frac{\langle{xx''}\rangle}{\tilde{x}} + \frac{\varepsilon_x^2}{\tilde{x}^3}
\end{align}

---


Now get $\langle{xx''}\rangle$ from equation of motion:
...
&= 0
\\
xx'' + \frac{(\gamma\beta)'}{(\gamma\beta)} xx'
+\kappa_x(s) x^2 - \frac{q}{m c^2 \beta^2 \gamma^3} x \frac{\partial \phi}{\partial x}
&= 0
\\
\langle{xx''}\rangle + \frac{(\gamma\beta)'}{(\gamma\beta)} \langle{xx'}\rangle
+\kappa_x(s) \langle{x^2}\rangle - \frac{q}{m c^2 \beta^2 \gamma^3} \langle{ x \frac{\partial \phi}{\partial x} }\rangle
&= 0
\end{align}
...
- \frac{q}{mc^2 \beta^2 \gamma^3} \frac{\langle x \partial{\phi}/\partial{x} \rangle}{\tilde{x}}
&= 0
\\
\tilde{y}'' 
...
- \frac{q}{mc^2 \beta^2 \gamma^3} \frac{\langle y \partial{\phi}/\partial{y} \rangle}{\tilde{y}}
&= 0
\end{align}
...
\begin{align}
\langle x \frac{\partial \phi}{\partial x} \rangle &= -\frac{\lambda}{4 \pi \epsilon_0} \frac{\tilde{x}}{\tilde{x} + \tilde{y}} , \\
\langle y \frac{\partial \phi}{\partial y} \rangle &= -\frac{\lambda}{4 \pi \epsilon_0} \frac{\tilde{x}}{\tilde{x} + \tilde{y}} .
\end{align}
...
\begin{equation}
Q  = \frac{\lambda}{mc^2\beta^2\gamma^3} \frac{2 q}{4 \pi \epsilon_0} .
\end{equation}
