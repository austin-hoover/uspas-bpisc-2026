...
\begin{align}
p_\theta &\equiv \gamma \beta m c r^2 \theta' + \frac{m \omega_c r^2}{2} 
\\
\langle p_\theta \rangle &= \gamma \beta m c \langle{r^2 \theta'}\rangle + \frac{m \omega_c \langle{r^2}\rangle}{2}
\\
\vdots 
\\
...
- \left( \frac{\langle p_\theta \rangle}{\gamma \beta m c} \right)^2 \frac{1}{\tilde{r}^3}
...
\begin{align}
{x}'' + \frac{(\gamma\beta)'}{(\gamma\beta)} {x}' 
&= \frac{q}{\gamma m \beta^2 c^2} \left[ {E}_x + \beta c \left( y' B_z - B_y \right) - \frac{1}{\gamma^2} \frac{\partial^2 \phi}{\partial {x}} \right] 
\\
{y}'' + \frac{(\gamma\beta)'}{(\gamma\beta)} {y}' 
&= \frac{q}{\gamma m \beta^2 c^2} \left[ {E}_y + \beta c \left( B_x - x' B_z \right) - \frac{1}{\gamma^2} \frac{\partial^2 \phi}{\partial {y}} \right]
\end{align}


---

Assume no external electric field ($E_x = E_y = 0$) and approximate magnetic field as $B_y = G x$, $B_x = -G y$.
