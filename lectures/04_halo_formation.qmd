...
![To do: limit range from -$\epsilon$ to $\epsilon$.](images/pcm_eps_cos_vs_w.png){#fig-ham-eps-cos-psi width=400px}

![Hamiltonian contours as function of $w \cos\Psi$ and $w\sin\Psi$.](images/pcm_contours_polar.png){#fig-ham-polar width=400px}

![Hamiltonian contours as function of $x \propto \sqrt{w} \sin\Psi$ and $x' \propto \sqrt{w}\cos\Psi$.](images/pcm_contours_xy.png){#fig-ham-xxp width=400px}
